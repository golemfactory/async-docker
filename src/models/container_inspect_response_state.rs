...
/// ContainerInspectResponseState : The state of the container.
...
impl ContainerInspectResponseState {
    /// The state of the container.
    pub fn new() -> ContainerInspectResponseState {
    ...
    pub fn with_status(mut self, status: String) -> ContainerInspectResponseState {
        self.status = Some(status);
        self
    }
    ...
    pub fn with_running(mut self, running: bool) -> ContainerInspectResponseState {
        self.running = Some(running);
        self
    }
    ...
    pub fn with_paused(mut self, paused: bool) -> ContainerInspectResponseState {
        self.paused = Some(paused);
        self
    }
    ...
    pub fn with_restarting(mut self, restarting: bool) -> ContainerInspectResponseState {
        self.restarting = Some(restarting);
        self
    }
    ...
    pub fn with_oom_killed(mut self, oom_killed: bool) -> ContainerInspectResponseState {
        self.oom_killed = Some(oom_killed);
        self
    }
    ...
    pub fn with_dead(mut self, dead: bool) -> ContainerInspectResponseState {
        self.dead = Some(dead);
        self
    }
    ...
    pub fn with_pid(mut self, pid: i32) -> ContainerInspectResponseState {
        self.pid = Some(pid);
        self
    }
    ...
    pub fn with_exit_code(mut self, exit_code: i32) -> ContainerInspectResponseState {
        self.exit_code = Some(exit_code);
        self
    }
    ...
    pub fn with_error(mut self, error: String) -> ContainerInspectResponseState {
        self.error = Some(error);
        self
    }
    ...
    pub fn with_started_at(mut self, started_at: String) -> ContainerInspectResponseState {
        self.started_at = Some(started_at);
        self
    }
    ...
    pub fn with_finished_at(mut self, finished_at: String) -> ContainerInspectResponseState {
        self.finished_at = Some(finished_at);
        self
    }
