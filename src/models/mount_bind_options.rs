...
impl MountBindOptions {
    ...
    pub fn set_non_recursive(&mut self, non_recursive: bool) {
        self.non_recursive = Some(non_recursive);
    }

    pub fn with_non_recursive(mut self, non_recursive: bool) -> MountBindOptions {
        self.non_recursive = Some(non_recursive);
        self
    }

    pub fn non_recursive(&self) -> Option<&bool> {
        self.non_recursive.as_ref()
    }

    pub fn reset_non_recursive(&mut self) {
