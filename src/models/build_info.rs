...
impl BuildInfo {
    ...
    pub fn set_aux(&mut self, aux: ::models::ImageId) {
        self.aux = Some(aux);
    }

    pub fn with_aux(mut self, aux: ::models::ImageId) -> BuildInfo {
        self.aux = Some(aux);
        self
    }

    pub fn aux(&self) -> Option<&::models::ImageId> {
        self.aux.as_ref()
    }
