...
pub struct TaskSpec {
    ...
    network_attachment_spec: Option<::models::TaskSpecNetworkAttachmentSpec>,
...
impl TaskSpec {
    ...
    pub fn set_network_attachment_spec(
        &mut self,
        network_attachment_spec: ::models::TaskSpecNetworkAttachmentSpec,
    ) {
    ...
    pub fn network_attachment_spec(&self) -> Option<&::models::TaskSpecNetworkAttachmentSpec> {
