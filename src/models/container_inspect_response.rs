...
pub struct ContainerInspectResponse {
    ...
    #[serde(rename = "State")]
    state: Option<::models::ContainerInspectResponseState>,
...
impl ContainerInspectResponse {
    ...
    pub fn set_state(&mut self, state: ::models::ContainerInspectResponseState) {
        self.state = Some(state);
    }

    pub fn with_state(
        mut self,
        state: ::models::ContainerInspectResponseState,
    ) -> ContainerInspectResponse {
        self.state = Some(state);
        self
    }

    pub fn state(&self) -> Option<&::models::ContainerInspectResponseState> {
        self.state.as_ref()
    }
    ...
    pub fn with_mounts(mut self, mounts: Vec<::models::MountPoint>) -> ContainerInspectResponse {
        self.mounts = Some(mounts);
        self
    }
    ...
    pub fn with_config(mut self, config: ::models::ContainerConfig) -> ContainerInspectResponse {
        self.config = Some(config);
        self
    }
