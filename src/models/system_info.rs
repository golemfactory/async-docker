...
impl SystemInfo {
    ...
    pub fn set_product_license(&mut self, product_license: String) {
        self.product_license = Some(product_license);
    }

    pub fn with_product_license(mut self, product_license: String) -> SystemInfo {
        self.product_license = Some(product_license);
        self
    }

    pub fn product_license(&self) -> Option<&String> {
        self.product_license.as_ref()
    }

    pub fn reset_product_license(&mut self) {
        self.product_license = None;
    }
    ...
    pub fn with_warnings(mut self, warnings: Vec<String>) -> SystemInfo {
        self.warnings = Some(warnings);
        self
    }
