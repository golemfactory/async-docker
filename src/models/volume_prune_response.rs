...
impl VolumePruneResponse {
    ...
    pub fn with_volumes_deleted(mut self, volumes_deleted: Vec<String>) -> VolumePruneResponse {
        self.volumes_deleted = Some(volumes_deleted);
        self
    }
    ...
    pub fn with_space_reclaimed(mut self, space_reclaimed: i64) -> VolumePruneResponse {
        self.space_reclaimed = Some(space_reclaimed);
        self
    }
