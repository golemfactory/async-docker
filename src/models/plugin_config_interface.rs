...
impl PluginConfigInterface {
    ...
    pub fn set_protocol_scheme(&mut self, protocol_scheme: String) {
        self.protocol_scheme = Some(protocol_scheme);
    }

    pub fn with_protocol_scheme(mut self, protocol_scheme: String) -> PluginConfigInterface {
        self.protocol_scheme = Some(protocol_scheme);
        self
    }

    pub fn protocol_scheme(&self) -> Option<&String> {
        self.protocol_scheme.as_ref()
    }

    pub fn reset_protocol_scheme(&mut self) {
        self.protocol_scheme = None;
    }
}
