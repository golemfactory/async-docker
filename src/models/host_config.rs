...
pub struct HostConfig {
    ...
    port_bindings: Option<::models::PortMap>,
...
impl HostConfig {
    ...
    pub fn set_port_bindings(&mut self, port_bindings: ::models::PortMap) {
        self.port_bindings = Some(port_bindings);
    }

    pub fn with_port_bindings(mut self, port_bindings: ::models::PortMap) -> HostConfig {
        self.port_bindings = Some(port_bindings);
        self
    }

    pub fn port_bindings(&self) -> Option<&::models::PortMap> {
