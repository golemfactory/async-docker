...
pub struct SystemDataUsageResponse {
    ...
    build_cache: Option<Vec<::models::BuildCache>>,
}
...
impl SystemDataUsageResponse {
    ...
    pub fn with_layers_size(mut self, layers_size: i64) -> SystemDataUsageResponse {
        self.layers_size = Some(layers_size);
        self
    }
    ...
    pub fn with_images(mut self, images: Vec<::models::ImageSummary>) -> SystemDataUsageResponse {
        self.images = Some(images);
        self
    }
    ...
    pub fn with_volumes(mut self, volumes: Vec<::models::Volume>) -> SystemDataUsageResponse {
        self.volumes = Some(volumes);
        self
    }
    ...
    pub fn set_build_cache(&mut self, build_cache: Vec<::models::BuildCache>) {
        self.build_cache = Some(build_cache);
    }

    pub fn with_build_cache(
        mut self,
        build_cache: Vec<::models::BuildCache>,
    ) -> SystemDataUsageResponse {
        self.build_cache = Some(build_cache);
        self
    }

    pub fn build_cache(&self) -> Option<&Vec<::models::BuildCache>> {
        self.build_cache.as_ref()
    }

    pub fn reset_build_cache(&mut self) {
